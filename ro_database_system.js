...
export const EQUIPMENT_SLOTS = ['helm', 'armor', 'weapon', 'shield', 'garment', 'shoes', 'acc1', 'acc2'];
export const SLOT_NAMES = { helm:'頭飾', armor:'鎧甲', weapon:'武器', shield:'盾牌/副手', garment:'披肩', shoes:'鞋靴', acc1:'飾品', acc2:'飾品' };
export const SLOT_ICONS = { helm:'👑', armor:'👕', weapon:'⚔️', shield:'🛡️', garment:'🧥', shoes:'👢', acc1:'💍', acc2:'💍' };
...
export const SETTINGS = {
  ...
  DEFAULT_STATE: {
    ...
    skills: { points: 1 }, 
    equipment: { helm: null, armor: 'a_001', weapon: 'w_002', shield: 'sh_002', garment: 'g_001', shoes: 's_001', acc1: null, acc2: null },
...
export const CLASSES = {
  ...
  swordman: { name: '劍士', job2: '騎士', icon: '🛡️', primaryStat: 'str', hpMulti: 1.5, spMulti: 0.8, atkMulti: 1.0, defMulti: 1.2, advClasses: ['knight', 'crusader'] },
  magician: { name: '魔法師', job2: '巫師', icon: '🔮', primaryStat: 'int', hpMulti: 0.8, spMulti: 2.0, atkMulti: 1.5, defMulti: 0.7, advClasses: ['wizard', 'sage'] },
...
export const JOBEXP_TABLE0 = [
  0, //0, 
  12, 22, 35, 50, 113, 188, 256, 335, 425,550
];
