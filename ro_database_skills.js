export const RO_DATABASE_SKILLS = {
  ...
  data: {
    ...
    monk: [
      ['mo_ashura', '阿修羅霸凰拳', '👊', 'active',  5,  25, (lv) => `消耗所有 SP，造成毀滅性真實傷害，施放後 5 分鐘無法回魔`, { spCost: 'all', dmgMulti: (lv) => player.baselevel * (8 + Math.floor(player.sp / 10)) + lv * 250, hits: 1, ignoreDef: true, ignoreFlee: true } ],
