export const RO_DATABASE_SKILLS = {
  ...
  data: {
    ...
    monk: [
      ['mo_ashura', '阿修羅霸凰拳', '👊', 'active',  5,  25, (lv) => `消耗大量 SP，造成毀滅性真實傷害，施放後 5 分鐘無法回魔`, { spCost: 999, dmgMulti: (lv) => 10.0 + lv * 2.0*(8+(9999/10)*(atk+matk), hits: 1, ignoreDef: true, ignoreFlee: true } ],
